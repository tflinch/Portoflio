                ...
                <div className="wrapper" data-width="wide">
                    <div className="equal-columns" data-gap="large" data-alignment="centered">
                        ...
                        <div className="flow font-family-basic">
                            ...
                            <p className="about_content">
                                Throughout my career, I’ve had the privilege of contributing to projects that challenge me to combine technical expertise with creative thinking. From leading the development of a fire alert system leveraging geolocation and Leaflet.js, to building dynamic APIs for robotic automation, I’ve consistently embraced opportunities to expand my skill set and deliver solutions that address real-world challenges.                                        </p>
                            <p className="about_content">
