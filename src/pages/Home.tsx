          ...
          <div className='sub_wrapper'>
            ...
            <div className='flex-group'>
              <select
                ...
                id='platform'
                onChange={(e) =>
                  handleFilterChange(e.target.value, filterCategory)
                }
              >
              ...
              <select
                ...
                id='category'
                onChange={(e) =>
                  handleFilterChange(filterPlatform, e.target.value)
                }
              >
                <option value='all'>Type: All</option>
                ...
                <div className='projects__modal'>
                  <div>
                    <ul className='tag-list' role='list'>
                      <li data-platform={project.platform}>
                        {project.platform}
                      </li>
